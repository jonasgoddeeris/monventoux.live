...
$e_body = "You have been contacted by $name_contact  with additional message is as follows." . PHP_EOL . PHP_EOL;
$e_content = "\"$message_contact\"" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $name_contact via email, $email_contact.";
...
$usermessage = "Thank you for contacting Mon Ventoux. We will reply shortly!";

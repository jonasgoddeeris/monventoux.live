...
if(trim($name_contact) == '') {
	echo '<div class="error_message">Vul je voornaam in.</div>';
	exit();
	...
	echo '<div class="error_message">Gelieve een bericht in te vullen</div>';
	exit();
}
...
$e_subject = 'Je bent gecontacteerd door ' . $name_contact . '.';

// You can change this if you feel that you need to.
$e_body = "Je bent gecontacteerd door $name_contact op de NL website met volgend bericht." . PHP_EOL . PHP_EOL;
$e_content = "\"$message_contact\"" . PHP_EOL . PHP_EOL;
$e_reply = "Neem contact op met  $name_contact via email, $email_contact";
...
$user = "$email_contact";
$usersubject = "Bedankt - Chambre d'hôtes - Mon ventoux";
$userheaders = "From: info@monventoux.com";
$usermessage = "Bedankt op contact op te nemen met Mon Ventoux. We antwoorden zo snel mogelijk!";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<strong >Email verzonden.</strong>";
	echo "Bedankt <strong>$name_contact</strong>,<br> je bericht is verzonden. We nemen snel contact met je op.";
	echo "</div>";
